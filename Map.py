...
class Map:
  def __init__(self):
    ...
    self.objects.append(BoxObject(Vector3(5400,-300,-300), Vector3(200, 1, 0)))
    self.objects.append(BoxObject(Vector3(5400,-300,-300), Vector3(1, 200, 0)))
    self.objects.append(BoxObject(Vector3(5400,-100,-300), Vector3(200, 1, 0)))
    self.objects.append(BoxObject(Vector3(5600,-300,-300), Vector3(1, 200, 0)))
    self.objects.append(BoxObject(Vector3(5900,-300,-300), Vector3(200, 200, 200), is_walkable=True))
    self.objects.append(BoxObject(Vector3(5900,-300,-300), Vector3(200, 1, 0)))
    self.objects.append(BoxObject(Vector3(5900,-300,-300), Vector3(1, 200, 0)))
    self.objects.append(BoxObject(Vector3(5900,-100,-300), Vector3(200, 1, 0)))
    self.objects.append(BoxObject(Vector3(6100,-300,-300), Vector3(1, 200, 0)))
